...
AS $$
BEGIN
    INSERT INTO log(tableName, operation, ancienContenu, nouveauContenu)
    VALUES (p_tableName, p_operation, p_ancienContenu, p_nouveauContenu);
END;
$$;
...
-- INSERT
CREATE OR REPLACE FUNCTION trigger_section_create()
RETURNS TRIGGER AS $$
BEGIN
...
FOR EACH ROW
EXECUTE FUNCTION trigger_section_create();

-- UPDATE
CREATE OR REPLACE FUNCTION trigger_section_update()
RETURNS TRIGGER AS $$
BEGIN
    PERFORM insert_log_function(
        'section',
...
FOR EACH ROW
EXECUTE FUNCTION trigger_section_update();

-- DELETE
CREATE OR REPLACE FUNCTION trigger_section_delete()
RETURNS TRIGGER AS $$
BEGIN
    PERFORM insert_log_function(
        'section',
...
FOR EACH ROW
EXECUTE FUNCTION trigger_section_delete();


-- COURS -- 
-- INSERT
CREATE OR REPLACE FUNCTION trigger_cours_create()
RETURNS TRIGGER AS $$
BEGIN
    PERFORM insert_log_function(
        'cours',
...
FOR EACH ROW
EXECUTE FUNCTION trigger_cours_create();

-- UPDATE
CREATE OR REPLACE FUNCTION trigger_cours_update()
RETURNS TRIGGER AS $$
BEGIN
    PERFORM insert_log_function(
        'cours',
...
FOR EACH ROW
EXECUTE FUNCTION trigger_cours_update();

-- DELETE
CREATE OR REPLACE FUNCTION trigger_cours_delete()
RETURNS TRIGGER AS $$
BEGIN
    PERFORM insert_log_function(
        'cours',
...
FOR EACH ROW
EXECUTE FUNCTION trigger_cours_delete();



-- ETUDIANT --
-- INSERT
CREATE OR REPLACE FUNCTION trigger_etudiant_create()
RETURNS TRIGGER AS $$
BEGIN
    PERFORM insert_log_function(
        'etudiant',
...
FOR EACH ROW
EXECUTE FUNCTION trigger_etudiant_create();

-- UPDATE
CREATE OR REPLACE FUNCTION trigger_etudiant_update()
RETURNS TRIGGER AS $$
BEGIN
    PERFORM insert_log_function(
        'etudiant',
...
FOR EACH ROW
EXECUTE FUNCTION trigger_etudiant_update();

-- DELETE
CREATE OR REPLACE FUNCTION trigger_etudiant_delete()
RETURNS TRIGGER AS $$
BEGIN
    PERFORM insert_log_function(
        'etudiant',
...
FOR EACH ROW
EXECUTE FUNCTION trigger_etudiant_delete();
